...
class Solution {
  public void solution() throws Exception {
    ...
    long _N = Long.parseLong(br.readLine());
    long[] reqs = Arrays.stream(br.readLine().split(" ")).mapToLong(s -> Long.parseLong(s)).toArray();
    long budget = Long.parseLong(br.readLine());

    long left = 0, right = Arrays.stream(reqs).max().getAsLong();
    long mid, total;
